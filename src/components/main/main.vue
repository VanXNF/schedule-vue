<template>
  <Layout style="height: 100%" class="main">
    <Sider hide-trigger collapsible :width="140" :collapsed-width="64" v-model="collapsed" class="left-sider" :style="{overflow: 'hidden'}">
    ...
    <Layout>
      <Header class="header-con">
        <header-bar :collapsed="collapsed" @on-coll-change="handleCollapsedChange">
          ...
          <new-note-button  style="margin-right: 10px;"/>
...
import scheduleMenuList from '@/libs/schedule-menu'
import tagListMock from '@/libs/tags-list'

// import getTagList from '@/api/data'
import './main.less'
export default {
  name: 'Main',
  components: {
